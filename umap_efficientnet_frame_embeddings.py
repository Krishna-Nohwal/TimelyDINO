"""
UMAP real/fake split for a pretrained EfficientNet frame model, aggregated to videos.

This loads checkpoints produced by train_efficientnet_all.py, extracts the
penultimate EfficientNet feature for sampled frames, mean-pools them per video,
and saves only a real-vs-fake split UMAP.
