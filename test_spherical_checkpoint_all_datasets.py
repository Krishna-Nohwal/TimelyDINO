...
def parse_args():
    ...
    parser.add_argument("--cdfv3_root", default="/raid/krishna/cdfv3_face_crops")
    parser.add_argument("--cdfv3_csv", default="/raid/krishna/cdfv3_face_crops/manifest_cdfv3_face_crops.csv")
    parser.add_argument("--df0_fake_root", default="/raid/krishna/df1.0_faces/fake")
    parser.add_argument("--df0_real_root", default="/raid/krishna/df1.0_faces/real")
    parser.add_argument("--dfd_fake_root", default="/raid/krishna/dfd_faces/fake")
    parser.add_argument("--dfd_real_root", default="/raid/krishna/dfd_faces/real")
    parser.add_argument("--dfdc_fake_root", default="/raid/krishna/dfdc/fake")
    parser.add_argument("--dfdc_real_root", default="/raid/krishna/dfdc/real")
    parser.add_argument("--wdf_fake_root", default="/raid/krishna/wdf/test/fake")
    parser.add_argument("--wdf_real_root", default="/raid/krishna/wdf/test/real")
    parser.add_argument("--uadfv_fake_root", default="/raid/krishna/uadfv_faces/fake")
    parser.add_argument("--uadfv_real_root", default="/raid/krishna/uadfv_faces/real")
